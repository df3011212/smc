(() => {
  ...
  "把市場結構，變成一套": "Turn market structure into",
  "看得見的交易劇本": "a visible trading playbook",
  "整合支撐阻力、SMC、Order Block、FVG、流動性掃蕩、VWAP 與多週期平行通道，從方向、區域、結構確認到出場，集中在同一張圖表。": "Support and resistance, SMC, Order Blocks, FVG, liquidity sweeps, VWAP, and multi-timeframe parallel channels are combined on one chart—from direction and zones to structure confirmation and exits.",
  "四組多空情境路徑": "Four long/short scenario paths",
  "38 組警報條件": "38 alert conditions",
  "中英雙語介面": "Chinese / English interface",
  "在 TradingView 查看腳本": "View on TradingView",
  "查看完整教練手冊": "View the complete coach manuals",
  "作者／著作權人：Threads（@hongshihong19）": "Author / Copyright owner: Threads (@hongshihong19)",
  "FEATURED SCRIPT": "FEATURED SCRIPT",
  "多空雙向教練 v6.6.9": "Long/Short Trading Coach v6.6.9",
  "手冊下載": "Manuals",
  ...
  "腳本特色": "Script highlights",
  "核心特色": "Core features",
  "SR+SMC+VWAP 多空雙向教練圖表預覽": "SR+SMC+VWAP Long/Short Trading Coach chart preview",
  "開啟 TradingView 腳本頁面": "Open the TradingView script page",
  "上一張": "Previous slide",
  "下一張": "Next slide",
